...
import com.tc5u.vehiclemanger.adapter.SideBarBaseAdapter;
...
public class TitleDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        if (parent.getAdapter() == null || !(parent.getAdapter() instanceof SideBarBaseAdapter)) {
            return;
        }
        SideBarBaseAdapter adapter = (SideBarBaseAdapter) parent.getAdapter();
    ...
    public static class TitleAttributes {
        ...
        public TitleAttributes(Context context) {
            ...
            mBackgroundColor = Color.parseColor("#FFF5F5F5");
        }
