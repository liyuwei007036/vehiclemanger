...
public class EveChooseSeriesActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eve_choose_series);
        initToolBar();
        initView();
        initData();
        initSeriesData();
    ...
    private void initSeriesData() {
        ...
        data.put("brandId", brand_id);
        OkHttpUtils.getInstance().PostWithJson("/getSeriesByBrandId", data.toJSONString(), new OkHttpUtils.ResultCallBackListener() {
            @Override
            ...
            public void onSuccess(String url, String result_str) {
                ...
                if (res.getBoolean("valid")) {
                    JSONObject series = res.getJSONObject("data");
                    recycler.setAdapter(new SeriesAdapter(getSeries(series), series_id));
                    recycler.addItemDecoration(new TitleDecoration(new TitleDecoration.TitleAttributes(EveChooseSeriesActivity.this)));
                    recycler.addItemDecoration(new DividerItemDecoration(EveChooseSeriesActivity.this, DividerItemDecoration.VERTICAL));
                } else {
